  ...
  return (
    <div className="px-4 sm:px-6 lg:px-8 py-8 max-w-2xl mx-auto animate-pulse">
      ...
      <div className="bg-white rounded-2xl border border-[#E0E0EC] p-6 space-y-5">
        ...
        <div>
          <div className="h-4 bg-gray-200 rounded-md w-24 mb-1.5"></div>
          <div className="h-11 bg-gray-100 border border-gray-200 rounded-xl w-full mb-5"></div>
          <div className="h-4 bg-gray-200 rounded-md w-20 mb-2"></div>
          <div className="space-y-2">
            {[1, 2].map(i => <div key={i} className="h-14 bg-gray-100 border border-gray-200 rounded-xl w-full"></div>)}
          </div>
        </div>
