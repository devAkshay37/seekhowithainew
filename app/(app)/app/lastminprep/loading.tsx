    ...
    <div className="px-4 sm:px-6 lg:px-8 py-8 max-w-5xl mx-auto animate-pulse">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <div className="h-4 bg-gray-200 rounded-md w-28 mt-1"></div>
        </div>
        <div className="w-32 h-10 bg-[#E85D1E]/20 rounded-xl"></div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {[1, 2, 3, 4, 5, 6].map((i) => (
          <div key={i} className="bg-white/50 border border-[#E0E0EC] rounded-2xl p-5">
            ...
            <div className="h-4 bg-gray-200 rounded-md w-2/5 mb-4"></div>
            <div className="h-3 bg-gray-200 rounded-md w-3/5 mb-4"></div>
