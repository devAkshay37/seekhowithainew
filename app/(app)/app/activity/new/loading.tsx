      ...
      <div className="bg-white rounded-2xl border border-[#E0E0EC] p-6 space-y-5">
        ...
        <div>
          ...
          <div className="flex gap-2">
            {[1, 2].map(i => <div key={i} className="flex-1 py-5 rounded-xl bg-gray-100 border border-gray-200"></div>)}
          </div>
        </div>
        <div>
          <div className="h-4 bg-gray-200 rounded-md w-24 mb-2"></div>
          <div className="flex gap-2 flex-wrap">
            {[1, 2, 3, 4].map(i => <div key={i} className="flex-1 py-5 rounded-xl bg-gray-100 border border-gray-200 min-w-[60px]"></div>)}
          </div>
        </div>
